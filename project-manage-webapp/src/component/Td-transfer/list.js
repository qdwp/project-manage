...
var TdTransferList = (_temp = _class = function (_React$Component) {
  _inherits(TdTransferList, _React$Component);

  function TdTransferList(props) {
    _classCallCheck(this, TdTransferList);
  ...
  TdTransferList.prototype.componentDidMount = function componentDidMount() {
    var _this2 = this;
  ...
  TdTransferList.prototype.renderCheckbox = function renderCheckbox(props) {
    var _classNames;
  ...
  TdTransferList.prototype.matchFilter = function matchFilter(text, filterText) {
    var regex = new RegExp(filterText);
    return text.match(regex);
  };

  TdTransferList.prototype.render = function render() {
    var _classNames2,
        _this3 = this;
...
exports["default"] = TdTransferList;
