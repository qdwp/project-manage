...
var TdSearch = (_temp2 = _class = function (_React$Component) {
  _inherits(TdSearch, _React$Component);

  function TdSearch() {
    var _temp, _this, _ret;

    _classCallCheck(this, TdSearch);
  ...
  TdSearch.prototype.render = function render() {
